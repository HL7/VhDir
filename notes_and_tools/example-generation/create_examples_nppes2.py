...
addins = {'addin-org-role': ('organizationrole', 'org_roles') ,
            #'addin-pract-role': ('practitionerrole', 'pract_roles')
            }  # addin_type name: merged with type
...
pract = '20181206-small/practitioner/vhdr-practitioner-example-bundle',
...
prac_roles_addins ='20181206-large/addin-pract-role/vhdr-practitionerrole-addin-pract-role-example-bundle',
pract_roles1 = '20181206-large/practitionerrole/vhdir-pr-examples-bundle-6bb9a4a1664b439280400c9c9c85b79c',
pract_roles2 = '20181206-large/practitionerrole/vhdir-pr-examples-bundle-8a84ba06b0ed460b9c66f790128c779b',
                ...
                for p_bundle in p_bundles:
                    for p_entry in p_bundle.entry:
                        ...
                        (addin_networks[network.name][1] == "Greater Hartford Area" and z in hartford_zips)):
                            ...
                            # logging.info(f'practitionerrole for pract = {pract.name[0].text}, id = {pract.identifier[0].value} network = {network.name} identifier {network.identifier[0].value}')
                            ...
                            id_list[snakecase(f_type)].append((pr.identifier[0].value,f'{f_Type}/{pr.id}',pr.practitioner.display))
                            entries.append(f_templ.entries_templ(server_path,example,f_Type,pr.id))  # create dict using fstring template
